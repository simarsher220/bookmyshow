package com.example.bookmyshow.error.handler;

import com.example.bookmyshow.error.exception.GenericException;
import com.example.bookmyshow.error.exception.NotFoundException;
import com.example.bookmyshow.error.response.EmptyResponse;
import com.example.bookmyshow.error.response.ErrorResponse;
